...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            return
        buttons = [[
            InlineKeyboardButton('𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴', url=f"https://telegram.me/CineFanatic/29"),
            InlineKeyboardButton('📢 UᎮDΛTΞS 📢', url='https://telegram.me/CineFanatic')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
